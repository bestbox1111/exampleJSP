   		...
   		<div class="row">
   			...
   			<form method="post" action="updateAction.jsp? bbsID=<%= bbsID %>">
   				<table class="table table-striped" style="text-align: center; border: 1px, solid #dddddd">
	   				...
	   				<tbody>
	   					<tr>
	   						<td><input type="text" class="form-control" placeholder="글제목을 입력하세요" name="bbsTitle" maxlength="50" value="<%= bbs.getBbsTitle() %>"></td>
	   					</tr>
	   					<tr>
	   						<td><textarea class="form-control" placeholder="글내용을 입력하세요" name="bbsContent" maxlength="2048" style="height:300px;" ><%= bbs.getBbsContent() %></textarea></td>
	   					</tr>
